...
A Manifest V3 Chrome extension over the same local backend (`app.py`) used
by the web UI (`src/page/index.html`) — no new logic, just a second front
end for the same `verify_text()` pipeline.
